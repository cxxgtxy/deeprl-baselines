...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        if not distributed:
            ...
            q_values = q_func(observations_ph.get(), num_actions, scope="q_func")
            q_t1_best = get_distibute_q(q_values, v_min, v_max, atoms, observations_ph)
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        if not distributed:
            ...
            q_values = get_distibute_q(q_values_logit, v_min, v_max, atoms, observations_ph)
            q_values_perturbed = get_distibute_q(q_values_perturbed_logit, v_min, v_max, atoms, observations_ph)
        ...
        if not distributed:
            ...
            q_values_adaptive = get_distibute_q(q_values_adaptive_logit, v_min, v_max, atoms, observations_ph)
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        if double_q:
            ...
            if not distributed:
                ...
                q_tp1_using_online_net = q_func(obs_tp1_input.get(), num_actions, scope="q_func", reuse=True)
                q_tp1_best = get_distibute_q(q_tp1_using_online_net, v_min, v_max, atoms, obs_tp1_input)
            ...
            if not distributed:
                ...
                if distributed:
                    q_tp1_best = get_distibute_q(q_tp1, v_min, v_max, atoms, obs_tp1_input)
                    a_tp1_best = tf.argmax(q_tp1_best, 1)
